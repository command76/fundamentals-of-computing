...
def new_game():
    global my_tiles, state, turns, numbers
    

    # add code here
    numbers = list(range(0, DISTINCT_TILES)*2)
...
# draw handler
def draw(canvas):
    global my_tiles, numbers
    # add code here
    for i in range(16):
        my_tiles[i] = Tile(numbers[i], True, [TILE_WIDTH * i, 100])
